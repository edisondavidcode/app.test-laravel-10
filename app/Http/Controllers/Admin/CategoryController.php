...
class CategoryController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:admin.categories.edit')->only('update', 'edit');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.categories.edit', compact('category'))->with('info', 'La categoria se ha creado con exito');
    }
