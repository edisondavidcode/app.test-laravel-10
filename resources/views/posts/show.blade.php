<x-app-layout>
    <div class="container py-8 ml-12">
                ...
                <figure>
                    ...
                    @else
                        <img class="w-full h-72 object-cover object-center"
                            src="https://cdn.pixabay.com/photo/2022/04/22/04/43/background-7148805_640.jpg"
                            alt="">
                    @endif
                </figure>
                            ...
                            <a class="flex" href="{{ route('posts.show', $similar) }}">
                                ...
                                @else
                                    <img class="w-36 h-20 object-cover object-center"
                                        ...
                                        alt="">
                                @endif
                                <span class="ml-2 w-40  text-gray-600">{{ $similar->name }}</span>
                            </a>
                        </li>
                    @endforeach
                </ul>
